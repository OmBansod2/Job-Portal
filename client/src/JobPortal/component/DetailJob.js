           ...
           <p> <b>Number Of Application: </b> { item && item.jobCount.length}</p>
                ...
                <div className="col-8 m-auto">
                 <h3>Skill(s) required</h3>
                  {item && item.userId == userId && (
                     <button className='btn btn-primary'  onClick={()=> setShowEditForm(true)} style={{backgroundColor:"pink"}}>Add Skill</button>
                  )}
            ...
            <div className="row">
              {item && item.userId !== userId && (
                  ...
                  <Link to={`/apply/${match.params.id}`}><button className='btn btn-success m-auto' style={{backgroundColor:"pink"}}>Apply Now</button></Link> 
                  }  
               ...
               {item && item.userId == userId && (
                  <div className="col-2 m-auto">
                 <button className='btn btn-success m-auto' onClick={()=> setshowComAddForm(true)} style={{backgroundColor:"pink"}}> Add More Infor</button>
                </div> 
              )}
            ...
            <Modal show={showEditForm} onHide={handleEditForm}>
             ...
             <form onSubmit ={onSubmit}>
                        ...
                        <div className="form-group mt-2">
                             <button className="btn btn-primary" type="submit" style={{backgroundColor:"pink"}}>Save</button>
                         </div>
             </form> 
             </Modal.Body>
             <br />
        ...
        aria-labelledby="example-custom-modal-styling-title" >
             ...
             <form onSubmit ={onComInfoSubmit}>
                        ...
                        <div className="form-group mt-2">
                             ...
                             style={{borderRadius:"25px",height:"50px",width:"90px",backgroundColor:"pink"}}>Save</button>
                         </div>
             </form> 
             </Modal.Body>
             <br />
